...
- [ ] **1.0 Scaffold Fase 1 + gate ADR-026** — PRD T0 (T0.1–T0.5)
  ...
  **Acceptance criteria:**
  ...
  - [ ] 1.2 Criar stub inicial `sdk_facade.py` (sem `cursor_sdk`)
  ...
  - [ ] 1.3 Preservar `__version__` e preparar re-exports opcionais
  ...
  - [ ] 1.4 Esqueleto `test_facade_imports.py` (RED condicional)
  ...
  - [ ] 1.5 Validar gate ADR-026 após scaffold
    - **File**: — (verificação)
...
- [ ] **2.0 Contrato público + taxonomia de erros** — PRD T1 (tipos + ADR-024)
  ...
  **Acceptance criteria:**
  ...
  - [ ] 2.1 Teste TDD dos tipos públicos (`RunResult`, `RunStatus`, `StreamCallbacks`)
  ...
  - [ ] 2.2 Implementar tipos e `SdkFacade` Protocol em `sdk_facade.py`
  ...
  - [ ] 2.3 Teste TDD da hierarquia `CursorAgentError`
  ...
  - [ ] 2.4 Implementar `src/cursor_agent/errors.py`
  ...
  - [ ] 2.5 Re-exportar tipos públicos em `__init__.py` (opcional)
    - **File**: `src/cursor_agent/__init__.py` (modify existing)
...
- [ ] **3.0 Adapter de shape do SDK + estratégia de stream** — PRD gap §9 / FR-6
  ...
  **Acceptance criteria:**
  ...
  - [ ] 3.1 Teste TDD `run_result_mapping` com fakes de shape SDK
  ...
  - [ ] 3.2 Implementar funções puras de mapeamento (`map_wait_result`, `extract_assistant_text`)
    - **File**: `src/cursor_agent/sdk_facade.py` (modify existing)
  ...
  - [ ] 3.3 Documentar estratégia de stream no módulo
    - **File**: `src/cursor_agent/sdk_facade.py` (modify existing)
  ...
  - [ ] 3.4 (Opcional) Micro-teste de integração para capturar shape real
...
- [ ] **4.0 `FakeSdkFacade` determinística** — PRD T3 + FR-8, FR-10
  ...
  **Acceptance criteria:**
  ...
  - [ ] 4.1 Teste TDD create + send happy path (fake)
  ...
  - [ ] 4.2 Implementar `FakeSdkFacade` — create, send, close
    - **File**: `src/cursor_agent/sdk_facade.py` (modify existing)
  ...
  - [ ] 4.3 Teste TDD gancho de run em andamento (`asyncio.Event`)
    - **File**: `tests/unit/test_facade.py` (modify existing)
  ...
  - [ ] 4.4 Implementar gancho de busy no `FakeSdkFacade`
    - **File**: `src/cursor_agent/sdk_facade.py` (modify existing)
  ...
  - [ ] 4.5 Teste TDD `StreamCallbacks` na fake
    - **File**: `tests/unit/test_facade.py` (modify existing)
  ...
  - [ ] 4.6 Implementar dispatch de callbacks na fake
    - **File**: `src/cursor_agent/sdk_facade.py` (modify existing)
...
- [ ] **5.0 `AsyncSdkFacade` com bridge mockado** — PRD T2 (FR-3–FR-7)
  ...
  **Acceptance criteria:**
  ...
  - [ ] 5.1 Teste TDD context manager (`__aenter__` / `__aexit__`)
    - **File**: `tests/unit/test_facade.py` (modify existing)
  ...
  - [ ] 5.2 Implementar `AsyncSdkFacade.__aenter__` / `__aexit__` e construtor
    - **File**: `src/cursor_agent/sdk_facade.py` (modify existing)
  ...
  - [ ] 5.3 Teste TDD `create_agent` (local, composer-2.5)
    - **File**: `tests/unit/test_facade.py` (modify existing)
  ...
  - [ ] 5.5 Teste TDD `resume_agent` com MCP re-inject (stub)
    - **File**: `tests/unit/test_facade.py` (modify existing)
  ...
  - [ ] 5.6 Implementar `resume_agent` + stub `tool_profile` → `mcp_servers`
  ...
  - [ ] 5.7 Teste TDD `send` com stream mockado
    - **File**: `tests/unit/test_facade.py` (modify existing)
  ...
  - [ ] 5.9 Teste TDD retry `is_retryable` (pré-run)
    - **File**: `tests/unit/test_facade.py` (modify existing)
  ...
  - [ ] 5.10 Implementar política de retry em operações pré-run
    - **File**: `src/cursor_agent/sdk_facade.py` (modify existing)
  ...
  - [ ] 5.12 Implementar `cancel` e `close`
    - **File**: `src/cursor_agent/sdk_facade.py` (modify existing)
...
- [ ] **6.0 Observabilidade, isolamento e handoff** — PRD DoD + retro PRD-002
  ...
  **Acceptance criteria:**
  ...
  - [ ] 6.1 Teste TDD logs NDJSON send start/end
    - **File**: `tests/unit/test_facade.py` (modify existing)
  ...
  - [ ] 6.2 Implementar emissor NDJSON com redaction
  ...
  - [ ] 6.3 Consolidar `test_facade_imports.py` pós-`AsyncSdkFacade`
  ...
  - [ ] 6.4 Executar gate de qualidade local (sem integração)
    - **File**: — (verificação)
  ...
  - [ ] 6.5 Executar `/code-review` antes do handoff
  ...
  - [ ] 6.6 Revisar PRD-002 com aprendizados da facade (retroalimentação)
  ...
  - [ ] 6.7 Confirmar ausência de artefatos fora de escopo
    - **File**: — (review)
