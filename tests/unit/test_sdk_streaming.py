...
@pytest.mark.asyncio
async def test_dispatch_stream_message_invokes_on_tool_start_for_running_status() -> (
    None
):
...
@pytest.mark.asyncio
async def test_dispatch_stream_message_invokes_on_tool_end_for_completed_status() -> (
    None
):
    ended: list[tuple[str, dict[str, object]]] = []
